/*! JST global build v0.5.0 — generated by tools/build_global.mjs. Do not edit by hand. */
...
const prevent = fn => event => { event.preventDefault(); return fn && fn(event) }

/** Call event.stopPropagation() synchronously, then the handler (if given). */
const stop = fn => event => { event.stopPropagation(); return fn && fn(event) }
